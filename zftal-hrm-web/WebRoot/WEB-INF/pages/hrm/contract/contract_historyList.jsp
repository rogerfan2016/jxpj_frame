...
<html>
	<head>
		...
		$(function(){
			...
			$("button[name='search']").click(function(e){//搜索按钮
				...
				requestData1('/contractNew_historyList',$("#search input, #search select").serialize());	
	...
	<body>
		...
		<form id="search" method="post" action="<%=request.getContextPath()%>/contract/contractNew_view.html">
			<input type="hidden" name="path" value="/contractNew_historyList"/>
						...
						<tr>
			                ...
			                <td width="18%">
								<select style="width:134px" name="status">
									  <option value="">全部</option>
				                  <c:forEach items="${statusList }" var="st" begin="1">
