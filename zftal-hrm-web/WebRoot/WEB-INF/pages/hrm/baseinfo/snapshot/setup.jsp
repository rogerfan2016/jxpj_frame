  ...
  <head>
    ...
    $(function(){
        $("input[name='startDate']").click(function(){
			showDownPrompt(this,"选择开始执行日期，默认为午夜整点执行");
        });
		$("#action").click(function(){
			...
			$.post('<%=request.getContextPath()%>/baseinfo/snapshot_timing.html',param,function(data){
