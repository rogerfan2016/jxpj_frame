...
$(function(){
	...
	$("button[name='dataImport']").click(function(e){
		var form = $("#uploadForm");
		form.attr("action",_path+"/baseinfo/infoClassData_dataImpNoCheckGh.html");
...
function downloadEntity(id){//模板下载
	window.location.href = _path + "/baseinfo/infoClassData_dTemplateNoCheckGh.html?classId="+id;
}
