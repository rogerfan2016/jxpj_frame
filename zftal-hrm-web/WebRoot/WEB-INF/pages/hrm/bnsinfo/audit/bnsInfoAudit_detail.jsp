...
<html>
  <head>
    ...
    $(function(){
            var params={idInput:$("input[name=businessInfoChange\\.id]"),
                        container1:$("#content1"),
                        container2:$("#content2"),
                        billConfigId:'${spBusiness.billId }',
                        billInstanceId:'${businessInfoChange.billInstanceId }',
                        approveBillClassesPrivilege:'${privilegeExpression}',
                        passAuditUrl:"/bnsinfo/infoaudit_pass.html?query.classId=${query.classId}&reAudit=${reAudit}",
                        rejectAuditUrl:"/bnsinfo/infoaudit_reject.html?query.classId=${query.classId}&reAudit=${reAudit}",
                        saveAuditUrl:"/bnsinfo/infoaudit_save.html?query.classId=${query.classId}&reAudit=${reAudit}",
                        backAuditUrl:"/bnsinfo/infoaudit_back.html?query.classId=${query.classId}&reAudit=${reAudit}",
                        returnUrl:"/bnsinfo/infoaudit_page.html?query.classId=${query.classId}"};
    ...
    function loadContent(params){
        ...
        var inputs ="spBillConfig.id="+params.billConfigId+"&spBillInstance.id="+params.billInstanceId
                +"&privilegeExpression="+params.approveBillClassesPrivilege+"&localEdit=false";;
        $.ajax({
