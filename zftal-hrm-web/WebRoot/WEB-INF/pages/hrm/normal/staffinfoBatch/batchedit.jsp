...
<html>
    <head>
        ...
        $(function(){
            $('#action').click(function(){
            	$.post("<%=request.getContextPath()%>/normal/staffBatch_batchModify.html",
        ...
        function findProperties(){
            $.post("<%=request.getContextPath()%>/normal/staffBatch_findProperties.html",
                $("#batchEdit").serialize(),function(data){
    ...
    <body>
        ...
        <form id="batchEdit" action="/normal/staffBatch_batchModify.html">
