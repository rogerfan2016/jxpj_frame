    ...
    $(function(){
          jsImport_<%=pageIndex%>("<%=request.getContextPath()%>/js/tip/tip.js");
            ...
            $("button[name='search']").click(function(e){//搜索按钮
                $("#search").attr("action","<%=request.getContextPath()%>/infochange/inputaudit_page.html");
            ...
            function refreshButton(){
                ...
                if(status == "NO_PASS_AUDITING"){
                    $("#btn_resh").parent().show();
                }
                if(status == "PASS_AUDITING"){
                	$("#btn_resh").parent().show();
                	$("#btn_bj").parent().show();
                }
                if(status != ""){
            ...
            function redetail(){
                ...
                $.post(_path+"/infochange/inputaudit_checkNode.html?infoChange.id="+id,"",function(data){
                    if(data.success){
                    	goUrl(_path+"/infochange/inputaudit_detail.html?query.classId="+classId+"&infoChange.id="+id+"&reAudit=true");
                    }else{
                        alert(data.text);
                    }
                },"json");
            ...
            function detail(){
                ...
                var id = $("input[id='id']:checked").val();
                var classId= $(current).attr("classId");
                goUrl(_path+"/infochange/inputaudit_detail.html?query.classId="+classId+"&infoChange.id="+id);
            }
            ...
            function edit(){
                ...
                var id = $("input[id='id']:checked").val();
                var classId= $(current).attr("classId");
                goUrl(_path+"/infochange/inputaudit_toEdit.html?query.classId="+classId+"&infoChange.id="+id);
            ...
            function view(){
                ...
                var id = $("input[id='id']:checked").val();
                var classId= $(current).attr("classId");
                goUrl(_path+"/infochange/inputaudit_view.html?query.classId="+classId+"&infoChange.id="+id);
        ...
        <!-- 按钮 -->
                <div class="buttonbox">
                    <ul>
                        ...
                        <li>
                            <a id="btn_resh" class="btn_sh">重新审核</a>
                        </li>
                         <li>
                            <a id="btn_bj" class="btn_xg">编 辑</a>
                        </li>
                    </ul>
                </div>
          <p class="toolbox_fot">
