  ...
  <head>
    ...
    $(function(){
            var params={idInput:$("input[name=infoChange\\.id]"),
                        ...
                        passAuditUrl:"/infochange/inputaudit_pass.html?query.classId=${query.classId}&reAudit=${reAudit}",
                        rejectAuditUrl:"/infochange/inputaudit_reject.html?query.classId=${query.classId}&reAudit=${reAudit}",
                        saveAuditUrl:"/infochange/inputaudit_save.html?query.classId=${query.classId}&reAudit=${reAudit}",
                        backAuditUrl:"/infochange/inputaudit_back.html?query.classId=${query.classId}&reAudit=${reAudit}",
    ...
    function loadContent(params){
        ...
        var inputs ="spBillConfig.id="+params.billConfigId+"&spBillInstance.id="+params.billInstanceId
                +"&privilegeExpression="+params.approveBillClassesPrivilege+"&localEdit=true&innerClick=true&saveLog=true";;
        $.ajax({
            ...
            <tfoot>
                <tr>
                    ...
                    <div class="btn">
                        ...
                        <s:if test="excutedList.size()>0&!redeclare">
