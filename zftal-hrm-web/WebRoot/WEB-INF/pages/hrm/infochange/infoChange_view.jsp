  ...
  <head>
    ...
    $(function(){
			$("#back").click(function(){//功能条增加按钮
				location.href = _path+"/infochange/infochange_page.html?query.classId=${query.classId}";
			});
...
<!--标题start-->
    <h3 class="datetitle_01">
    	<span>信息修改（红色表示修改后信息，鼠标悬停，显示原信息）<font color="#0457A7" style="font-weight:normal;" id="tip"></font></span>
    </h3>
	...
	<div id="content2">
		...
		<div class="por-rz">
			...
			<div id="logContent" class="por-rz-con">
