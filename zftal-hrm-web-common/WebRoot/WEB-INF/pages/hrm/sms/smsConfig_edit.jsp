...
<head>
    ...
    $(function(){
        ...
        $("#save_btn").click(function(){
            ...
            $.post("<%=request.getContextPath()%>/sms/smsTemplate_saveConfig.html",
        ...
        $("#testMail").click(function(){
            ...
            $.post("<%=request.getContextPath()%>/sms/smsTemplate_sendTestMail.html",
        ...
        <div class="tab">
            <table width="100%"  border="0" class="formlist" cellpadding="0" cellspacing="0">
                <thead>
                    <tr>
                        <th colspan="4">
                            <span><font color="#0f5dc2" style="font-weight:normal;">短信服务信息</font></span>
                        </th>
                    </tr>
                </thead>
                <tfoot>
        ...
        <div class="tab">
            <table width="100%"  border="0" class="formlist" cellpadding="0" cellspacing="0">
                <thead>
                    <tr>
                        <th colspan="4">
                            <span><font color="#0f5dc2" style="font-weight:normal;">发送测试短信</font></span>
                        </th>
                    </tr>
                </thead>
                <tfoot>
                    <tr>
                        <td colspan="4">
                            <div class="bz">以目前填入的鉴权信息发送测试短信到指定号码</div>
                            <div class="btn">
                                <button id="testMail" type="button">发送短信</button>
                            </div>
                        </td>
                    </tr>
                </tfoot>
                <tbody>
                    <tr>
                        ...
                        <td>
                            <input id="toMail" name="toSMS" style="width: 360px"/>
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <textarea id="content" name="smsCont" cols="50" rows="3" ></textarea>
                        </td>
                    </tr>
                </tbody>
            </table>
