							...
							<td>
								<table border="0" cellspacing="4"  align="right" style="border-collapse: separate;">
									<tr>
									  	<td>
									  		每页显示
									  		<input id="pageSize" name="query.showCount" value="${query.showCount }" onblur="changePageSize('1',${query.showCount });" size="2"/>条记录
									    </td>
									    <td>/共
								    ...
								    <input type="hidden" id="toPage" name="query.currentPage" value="${query.currentPage }"/>
								</table>
							</td>
						</tr>
					</table>
