...
(function() {
    ...
    var dftCfg = {
        ...
        //最大化按钮的提示文本
        allowSelect: false,
        //是否允许选择消息框内容，默认不允许 //是否允许在消息框使用右键，默认不允许
    ...
    (function() {
        ...
        var zindex=curCfg.zindex;
        div.innerHTML = [
        /*遮罩*/
        "<div id='maskLevel' style=\'" + maskStyle + ';z-index:'+ zindex +';\'></div>', IE6 ? ("<iframe id='maskIframe' src='javascript:false' style='" + maskStyle + ";z-index:"+ (zindex-1) +";filter:alpha(opacity=0);opacity:0'></iframe>") : '',
        /*窗体*/
        "<div id='ym-window' style='position:absolute;z-index:"+ (zindex+1) +";display:none'>", IE6 ? "<iframe src='javascript:false' style='width:100%;height:100%;position:absolute;top:0;left:0;z-index:-1'></iframe>": '', "<div class='ym-tl' id='ym-tl'><div class='ym-tr'><div class='ym-tc' style='cursor:move;'><div class='ym-header-text'></div><div class='ym-header-tools'>", "<div class='ymPrompt_min' title='最小化'><strong>0</strong></div>", "<div class='ymPrompt_max' title='最大化'><strong>1</strong></div>", "<div class='ymPrompt_close' title='关闭'><strong>r</strong></div>", "</div></div></div></div>", "<div class='ym-ml' id='ym-ml'><div class='ym-mr'><div class='ym-mc'><div class='ym-body' style='position:relative'></div></div></div></div>", "<div class='ym-ml' id='ym-btnl'><div class='ym-mr'><div class='ym-btn'></div></div></div>", "<div class='ym-bl' id='ym-bl'><div class='ym-br'><div class='ym-bc'></div></div></div>", "</div>",
        /*阴影*/
        isIE ? "<div id='ym-shadow' style='position:absolute;z-index:"+ (zindex) +";background:#808080;filter:alpha(opacity=80) progid:DXImageTransform.Microsoft.Blur(pixelradius=2);display:none'></div>": ''].join('');
        ...
        var setWinSize = function(w, h, pos) {
            ...
            if(top.window != window){
            	try{
	            	var windowHeight=jQuery(top.window).height();
	            	var scrollTop=jQuery(top.window).scrollTop();
	            	var tipwindowHeight=jQuery("#ym-window").height();
	            	var bodyOffsetTop=jQuery('#right',top.window.document.body).offset().top;
	            	topval=scrollTop + windowHeight/2 - tipwindowHeight/2 - bodyOffsetTop;
	            	if(topval<0){
	            		topval=0;
	            	}
            	}catch(e){
        ...
        var winVisible = function(visible) {
            ...
            jQuery(ym_body).html( !curCfg.iframe ? ('<div class="' + curCfg.msgCls + '">' + curCfg.message + '</div>') : "<iframe style='" + ifmStyle + "' border='0' frameborder='0' src='" + curCfg.message + "'></iframe><div style='" + ifmStyle + ";background:#000;opacity:0.1;display:none'></div>"); //内容
            (function(el, obj) {
